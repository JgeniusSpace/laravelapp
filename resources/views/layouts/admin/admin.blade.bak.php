                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li role="presentation" class="dropdown">
                            ...
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                <li>
                                    <a>
                                        <span class="image"><img src="{{ asset('back/images/img.jpg') }}" alt="Profile Image" /></span>
                                        <span>
...
<!-- Flot plugins -->
<script src="{{ asset('back/js/flot/jquery.flot.orderBars.js') }}"></script>
<script src="{{ asset('back/js/flot/date.js') }}"></script>
<script src="{{ asset('back/js/flot/jquery.flot.spline.js') }}"></script>
<script src="{{ asset('back/js/flot/curvedLines.js') }}"></script>
<!-- JQVMap -->
...
<script src="{{ asset('back/js/moment/moment.min.js') }}"></script>
<script src="{{ asset('back/js/datepicker/daterangepicker.js') }}"></script>
